...
<div class="container">
    ...
    <form class="form-signin" method="post" action="<?php echo site_url('login/login_in') ?>">
        <h2 class="form-signin-heading">登录系统</h2>
        <input type="text" name="username" class="input-block-level" placeholder="账号" id="userName">
        <input type="password" name="passwd" class="input-block-level" placeholder="密码" id="psd">
        <input type="text" name="captcha" class="input-medium" placeholder="验证码">
       	<div class="captcha">
				<img src="<?php echo site_url('login/code') ?>" alt="" />
		</div>
