...
--
-- Host: 127.0.0.1
-- Generation Time: 2017-03-03 18:45:26
...
INSERT INTO `hd_cases` (`caid`, `title`, `time`, `thumb`, `content`, `type`) VALUES
(3, '22222222222', 1488447611, '14884476116770.jpg', '<p>2222222222<br/></p>22222', 0);
...
(1, '010-5957 6563', '1309877947@qq.com', '北京市东城区朝阳门银河SOHO B20911', '暂时没有补充说明');
...
(3, 'd', 'www.lianjinclub.com', '14885256599214.jpg', '', '');
...
--
ALTER TABLE `hd_article`
  MODIFY `aid` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=51;
--
-- AUTO_INCREMENT for table `hd_cases`
--
ALTER TABLE `hd_cases`
  MODIFY `caid` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',AUTO_INCREMENT=5;
--
-- AUTO_INCREMENT for table `hd_category`
--
ALTER TABLE `hd_category`
  MODIFY `cid` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=26;
--
